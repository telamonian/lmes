...
#    get_directory_property( cmake_include_directories DIRECTORY ${pyx_path} INCLUDE_DIRECTORIES )
  ...
  add_custom_command( OUTPUT ${_generated_file}
    ...
    DEPENDS ${pyx_locations} ${pxd_dependencies} lm_c_lib
...
function( cython_add_module _name )
  ...
  python_add_module( ${_name} EXCLUDE_FROM_ALL ${generated_file} ${other_module_sources} )
  if( APPLE )
    set_target_properties( ${_name} PROPERTIES LINK_FLAGS "-undefined dynamic_lookup" )
#  else()
#    target_link_libraries( ${_name} ${PYTHON_LIBRARIES} ${CYTHON_OTHER_LIBS})
  endif()
#  target_link_libraries( ${_name} ${PYTHON_LIBRARIES} ${CYTHON_OTHER_LIBS})
endfunction()
