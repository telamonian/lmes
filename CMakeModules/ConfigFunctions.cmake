...
#function(chooseToolchain toolchain CCompilerPath CXXCompilerPath)
#    if(DEFINED ${CCompilerPath} AND DEFINED ${CXXCompilerPath})
#        foreach(lang C;CXX)
#            set(CMAKE_${lang}_COMPILER ${${lang}CompilerPath} PARENT_SCOPE)
#            message(STATUS "Using custom value for CMAKE_${lang}_COMPILER: ${${lang}CompilerPath}")
#        endforeach(lang)
#    else(DEFINED ${cCompilerPath} AND DEFINED ${cxxCompilerPath})
#        if(toolchain STREQUAL gnu)
#            set(CMAKE_C_COMPILER gcc PARENT_SCOPE)
#            set(CMAKE_C_COMPILER g++ PARENT_SCOPE)
#            set(toolchainSet yes)
#        elseif(toolchain STREQUAL clang)
#            set(CMAKE_C_COMPILER clang PARENT_SCOPE)
#            set(CMAKE_C_COMPILER clang++ PARENT_SCOPE)
#            set(toolchainSet yes)
#        elseif(toolchain STREQUAL intel)
#            set(CMAKE_C_COMPILER icc PARENT_SCOPE)
#            set(CMAKE_C_COMPILER icpc PARENT_SCOPE)
#            set(toolchainSet yes)
#        endif(toolchain STREQUAL gnu)
#        if(NOT toolchainSet)
#            message(WARNING "No support for specified CMAKE_TOOLCHAIN: ${toolchain}. Compiler set to CMake default.")
#        endif(toolchainSet)
#    endif(DEFINED ${cCompilerPath} AND DEFINED ${cxxCompilerPath})
#endfunction()
