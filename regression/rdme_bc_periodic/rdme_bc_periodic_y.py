...
topType=0
top=Cuboid(point(0.0,0.0,0.0), point(xlen,spacing*2,zlen), topType)
builder.addRegion(top)
midType=1
mid=Cuboid(point(0.0,spacing*2,0.0), point(xlen,spacing*3,zlen), midType)
builder.addRegion(mid)
botType=2
bot=Cuboid(point(0.0,spacing*3,0.0), point(xlen,ylen,zlen), botType)
