...
topType=0
top=Cuboid(point(0.0,0.0,0.0), point(xlen,ylen,zlen), topType)
builder.addRegion(top)
midType=1
mid=Cuboid(point(spacing*2,0.0,0.0), point(spacing*3,ylen,zlen), midType)
builder.addRegion(mid)
botType=2
bot=Cuboid(point(spacing*3,0.0,0.0), point(xlen,ylen,zlen), botType)
