...
opUpperLimit = [SimulationParameter(key='orderParameterUpperLimitList',val='0:25')]
...
raw_args = '-r 1-10 -sl lm::cme::GillespieDSolver -cr 1 -gr 0 -ff hdf5 -f "biphasic_switch.lm"'
