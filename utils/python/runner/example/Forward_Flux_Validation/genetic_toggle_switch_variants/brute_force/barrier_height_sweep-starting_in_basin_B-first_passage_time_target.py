...
#     xTicks = xTicks[:-1]
    ...
    simParams = [SimulationParameter(key='fptTrackingList',val='0,1,2,3,4,5,6'), 
                 SimulationParameter(key='orderParameterLowerLimitList',val='0:-25'),
    ...
    sweep_dict = {'cpu_count': 32,
                  ...
                  'rootPath': PathJoin(remote_home_directory, 'forward_flux_validation/gts_basin_B_opll_100_reps'),
                  'sweepTupX': sweepTupX,
                  'sweepTupY': sweepTupY,
                  'type': type,
                  'user_id': user_id}
