...
class FFluxHist(OParamHist):
    propertySpecs = DatumSpecs(DatumSpec(name='basin_n_order_parameter_values', paths=('phase_n_order_parameter_values',), SubDataType=OParamHists, type='subData'),
                               DatumSpec(name='basin_weights', columnLabels=('weight', 'basin_id'), dtype=[('weight','float'),('basin_id','int')], paths=('basin_weights',), storageType='numpy', type='array'),
                               ...
                               DatumSpec(name='phase_weights', columnLabels=('weight', 'basin_id', 'phase_id'), dtype=[('weight','float'),('basin_id','int'),('phase_id','int')], paths=('basin_weights',), storageType='numpy', type='array'),
                               ...
                               DatumSpec(name='trajectory_phase_map', columnLabels=('trajectory_id', 'basin_id', 'phase_id'), dtype=[('trajectory_id','int'),('basin_id','int'),('phase_id','int')], paths=('trajectory_phase_map',), storageType='numpy', type='array'))
