...
class FFluxHist(OParamHist):
    propertySpecs = DatumSpecs(DatumSpec(name='basin_weights', columnLabels=('weight', 'basin_id'), dtype=[('weight','float'),('basin_id','int')], paths=('basin_weights',), storageType='numpy', type='array'),
