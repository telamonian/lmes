...
class SpeciesTrajectoriesIO(HDF5IO):
    ...
    hdf5Specs = HDF5IOSpecs(HDF5IOSpec(name='number_entries', subKey='SpeciesCounts', type='special'),
                            HDF5IOSpec(name='number_species', subKey='SpeciesCounts', type='special'),
                            HDF5IOSpec(name='trajectory_id', subKey='ID', type='special'),
                            HDF5IOSpec(name='species_count', fullOnly=True, subKey='SpeciesCounts', type='dataset'),
