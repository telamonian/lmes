...
class FFluxHistsIO(OParamHistsIO):
    ...
    hdf5Specs = HDF5Specs(HDF5Spec(name='basin_n_order_parameter_values', fullOnly=False, IOType=OParamHistsIO, subKey='BasinHists', type='subData'),
                          HDF5Spec(name='basin_weights', fullOnly=False, subKey='BasinWeights', type='dataset'),
