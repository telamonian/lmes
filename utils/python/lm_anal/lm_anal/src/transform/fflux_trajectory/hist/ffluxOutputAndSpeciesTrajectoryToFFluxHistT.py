...
class FFluxOutputAndSpeciesTrajectoryToFFluxHistT(BaseT):
    ...
    transformSpecs = TransformSpecs(TransformSpec(srcTypes={FFluxOutput}, dstTypes={FFluxHist}, requiredArgs='tilingIDs', requiredData={'oparams', 'tilings'},
                                                  ...
                                                  PropertyTransformSpec(dstProps='basin_weights', srcProps='basins'),
                                                  PropertyTransformSpec(dstProps='phase_weights', srcProps='basins'),
                                                  PropertyTransformSpec(dstProps='trajectory_phase_map', srcProps='trajectories', requiredArgs='tilingIDs'))),
                                    TransformSpec(srcTypes={FFluxOutput}, srcDataTypes={SpeciesTrajectory}, dstTypes={FFluxHist}, requiredArgs='tilingIDs', requiredData={'oparams', 'tilings'},
                                                  propertyTransformSpecs=PropertyTransformSpecs(
                                                  PropertyTransformSpec(dstProps='order_parameter_values', srcProps='species_count', requiredArgs='tilingIDs'))))
