...
#         Transforms(srcs=self.specTraj, dsts=self.opTraj, oparams=self.oparams, oparamIDs=0)
    ...
    def test_number_order_parameters_from_transfrom(self):
        ...
        numberOP = self.oparamTrajectories[5].number_order_parameters
    ...
    def test_number_entries_from_transfrom(self):
        ...
        numberEntries = self.oparamTrajectories[5].number_entries
    ...
    def test_order_parameter_values_from_transfrom(self):
        ...
        orderParameterValuesArr = np.array(self.oparamTrajectories[5].order_parameter_values).flatten()
        ...
        self.assertArraysEqual(orderParameterValuesArr, intendedOrderParameterValuesArr)
    ...
    def test_time_from_transfrom(self):
        ...
        timeArr = np.array(self.oparamTrajectories[5].time).flatten()
        ...
        self.assertArraysEqual(timeArr, intendedTimeArr)
    ...
    def test_trajectory_id_from_transfrom(self):
        ...
        idInt = self.oparamTrajectories[5].trajectory_id
