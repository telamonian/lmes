...
from lm_anal.src.datum.trajectory.replicateTrajectories import ReplicateTrajectories
...
class ReplicateTrajectoriesTestCase(unittest.TestCase):
    ...
    def test_has(self):
        ...
        '''
        self.assertTrue(self.replicateTrajectories.has())
    
    def test_number_species_hdf5(self):
        '''
        test reading of number of species(s) from hdf5 files
        '''
        self.replicateTrajectories.rff()

        numberSpecies = self.replicateTrajectories[4].number_species
    ...
    def test_number_entries_hdf5(self):
        ...
        numberEntries = self.replicateTrajectories[4].number_entries
    ...
    def test_species_count_hdf5(self):
        ...
        speciesCountArr = np.array(self.replicateTrajectories[4].species_count).flatten()
    ...
    def test_time_hdf5(self):
        ...
        timeArr = np.array(self.replicateTrajectories[4].time).flatten()
    ...
    def test_trajectory_id_hdf5(self):
        ...
        idInt = self.replicateTrajectories[4].trajectory_id
        self.assertEqual(idInt, 4)
        
        idInt = self.replicateTrajectories[8].trajectory_id
