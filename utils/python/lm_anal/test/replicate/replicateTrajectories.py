...
class ReplicateTrajectoriesTestCase(unittest.TestCase):
    ...
    def test_number_species_hdf5(self):
        ...
        numberSpecies = self.replicateTrajectories[3].number_species
    ...
    def test_number_entries_hdf5(self):
        ...
        numberEntries = self.replicateTrajectories[3].number_entries
    ...
    def test_species_count_hdf5(self):
        ...
        speciesCountArr = np.array(self.replicateTrajectories[3].species_count).flatten()
